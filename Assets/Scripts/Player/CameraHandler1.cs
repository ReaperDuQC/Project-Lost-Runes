...
namespace LostRunes
{
    public class CameraHandler1 : MonoBehaviour
    {
        ...
        public static CameraHandler1 _singleton;
        ...
        private bool rightStick_Right_Input;
        private bool rightStick_Left_Input;
        ...
        public void LateUpdate()
        {
            ...
            HandleCameraRotation(Time.deltaTime, _cameraInput.x, _cameraInput.y);
        }
