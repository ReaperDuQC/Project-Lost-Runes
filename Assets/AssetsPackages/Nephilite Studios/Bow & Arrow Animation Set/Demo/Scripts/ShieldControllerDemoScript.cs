...
public class ShieldControllerDemoScript : MonoBehaviour
{
    Animator animator;
    ...
    private void HandleTwoHand()
    {
        if (Input.GetKeyDown(KeyCode.Y))
        {
            ...
            else if (!isTwoHandingWeapon && isBlocking)
            {
                ToggleOffHandWeapon();
            }
            else if (!isTwoHandingWeapon && !isBlocking)
    ...
    private void HandleRoll()
    {
        ...
        if (Input.GetKeyDown(KeyCode.R))
        {
            ...
            {
                PlayActionAnimation("OH_Roll_01", true);
            }
        }
    }
    ...
    private void TogglePrimaryWeapon()
    {
        primaryWeapon.SetActive(true);
        offHandWeapon.SetActive(false);
    }

    private void ToggleOffHandWeapon()
    {
