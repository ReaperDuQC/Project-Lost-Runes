...
Shader "InfinityPBR/IPBR_DiffuseHSL_Transparent_URP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 hsvTorgb6 = RGBToHSV( tex2D( _Diffuse, uv_Diffuse ).rgb );
				float clampResult14 = clamp( ( hsvTorgb6.y + _Saturation ) , 0.0 , 1.0 );
				float clampResult15 = clamp( ( hsvTorgb6.z + _Value ) , 0.0 , 1.0 );
				float3 hsvTorgb8 = HSVToRGB( float3(( hsvTorgb6.x + _Hue ),clampResult14,clampResult15) );
				

				float3 BaseColor = hsvTorgb8;
...
WireConnection;17;6;27;0
ASEEND*/
//CHKSM=664D92A60778A3F6F0F295F98E4074CBC55ACFE3